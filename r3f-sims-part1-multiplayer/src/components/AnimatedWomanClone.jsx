...
Command: npx gltfjsx@6.2.16 public/models/Animated_Woman.glb -o src/components/AnimatedWoman.jsx -r public 
*/
...
export function AnimatedWomanClone({ 
  hairColor = "green",
  topColor = "pink",
  bottomColor = "brown",
  ...props
  ...
  const group = useRef()
  const { scene, materials, animations } = useGLTF('/models/Animated_Woman.glb')
